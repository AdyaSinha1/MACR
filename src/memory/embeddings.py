...
class EmbeddingService:
    ...
    def __init__(self, model_name: str = "all-mpnet-base-v2", cache_file: str = "data/.embeddings_cache.json"):
        ...
        if not dimension:
            logger.warning("Failed to get sentence embedding dimension dynamically. Defaulting to 768.")
            self.dimension = 768
        else:
