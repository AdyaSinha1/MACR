...
def review(
    ...
    output: str = typer.Option("review_report.md", "--output", "-o", help="Output Markdown file"),
    verbose: bool = typer.Option(False, "--verbose", "-v", help="Enable debug logging"),
    use_memory: bool = typer.Option(True, "--use-memory/--no-memory", help="Enable FAISS memory context")
):
    ...
    if use_memory:
        try:
            ...
            typer.secho("Memory module not installed. Install with `pip install .[memory]`", fg=typer.colors.YELLOW)
            memory_store = None
